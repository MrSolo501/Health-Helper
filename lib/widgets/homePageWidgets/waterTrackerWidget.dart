        ...
        child: Column(
          ...
          children: [
              ...
              text:  TextSpan(
                children: [
                   TextSpan(
                    ...
                    style: TextStyle(
                    fontSize: 19.h, fontWeight: FontWeight.bold,color: Colors.black),
                  ),
                  TextSpan(
                    
                    text:  ' $_water💧',
                    style:  TextStyle(color: Colors.blue,fontSize: 30.h,fontWeight: FontWeight.bold)
                  )
                ]
            ...
            ElevatedButton(
              ...
              child:  Text("+1",
                  style: TextStyle(color: Colors.blue, fontSize: 26.h)),
            )
          ],
        ),
      ),
